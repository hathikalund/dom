...
current_attack = None
attack_history = [] 
TELEGRAM_BOT_TOKEN = '7877126466:AAH6lNFpehRtrqV7pU4Gl2hHV5UNupLLsfo:'
ADMIN_USER_ID = 1174779637
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user["coins"] < COINS_REQUIRED_PER_ATTACK:
        await context.bot.send_message(
            chat_id=chat_id,
            text="*💰 Insufficient coins! Please contact the admin to acquire more coins. DM: @SOULCRACKS*",
            parse_mode='Markdown'
        )
        return
...
async def help(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "- *If you encounter any issues, contact the admin: @HMSahil*\n\n"
